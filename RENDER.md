...
Variáveis adicionais, como SMTP, Gemini e outras integrações, devem ser configuradas no painel **Environment** do Render como variáveis secretas. Para desenvolvimento local e exemplos sem segredos reais, consulte o arquivo `.env.example`.
