...
for fp in files:
    if os.path.exists(fp):
        ...
        # Replace Kg/min -> min/Ton
        new_content = content.replace("Kg/min", "min/Ton")
        # Also clean up any lingering Kg/h if missed
        new_content = new_content.replace("Kg/h", "min/Ton")
